...
<section class="checkout spad">
    <div class="container">
        <div class="checkout__form">
            <form id="register_form" method="post" action="{{ route('register.perform') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-12 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="checkout__input">
                                    ...
                                    <input type="text" id="name" value="{{ old('name') }}" onkeyup="processChangeFirstName()" oninput="checkEmptyInput(isRegister)">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="checkout__input">
                                    <p>Email<span>*</span></p>
                                    <input type="text" id="email" value="{{ old('email') }}" onkeyup="processChangeEmail()" oninput="checkEmptyInput(isRegister)">
                        ...
                        <div class="checkout__input">
                            ...
                            <input type="password" id="password" value="{{ old('password') }}" onkeyup="processChangePassword()" oninput="checkEmptyInput(isRegister)">
